...
documents, ids = read_data(r'C:\Users\ASUS\Desktop\jupyter\jupyter\quora\corpus-processed.jsonl')
inverted_index=r'C:\Users\ASUS\Desktop\jupyter\jupyter\quora\inverted_index.json'
loaded_compressed_index = load_inverted_index(inverted_index)
vectorizer = TfidfVectorizer()
tfidf_matrix = vectorizer.fit_transform(documents)

query = "Which question should I ask on Quora?"
results = search_query(query,vectorizer,loaded_compressed_index)
